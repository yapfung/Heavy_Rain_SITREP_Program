                        ...
                        if len(rainfall_30min[1]) > 0:
                            for i in range(len(rainfall_30min[1])):
                                ...
                                run_text = '%s / %s / %s - %s' %(rainfall_30min[1][i]['rainfall'], rainfall_30min[1][i]['station'], 
                                                                   (rainfall_30min[1][i]['datetime']-dt.timedelta(minutes = 30)).strftime('%I.%M %p').replace('AM', 'am').replace('PM', 'pm').lstrip('0'), rainfall_30min[1][i]['datetime'].strftime('%I.%M %p').replace('AM', 'am').replace('PM', 'pm').lstrip('0'))                            
                                run = cell.paragraphs[i].add_run(run_text)
